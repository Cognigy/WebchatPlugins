...
const CreditCardCheckoutForm = (props) => {
...
const CreditCard = (props) => (
    <Elements stripe={stripePromise(props.stripePK)} options={ELEMENTS_OPTIONS}>
        <CreditCardCheckoutForm processButtonText={props.processButtonText} onSendMessage={props.onSendMessage} submitButtonText={props.submitButtonText} />
    </Elements>
);
