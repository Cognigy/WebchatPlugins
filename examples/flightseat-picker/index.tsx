...
const flightSeatPickerPlugin: MessagePluginFactory = ({ styled }) => {
    ...
    class FlightseatPicker extends React.Component<
        MessageComponentProps,
        State
    > {
        constructor(props) {
      ...
      */
        ...
        handleSubmit = () => {
            this.props.onSendMessage(
                `Row ${this.state.selectedSeats[0][0]}, Seat ${
                    this.state.selectedSeats[0][1]
                }`,
                {
        ...
        render() {
            ...
            try {
                ...
                numbermaxReservableSeats =
                    message.data._plugin.data.numbermaxReservableSeats
            ...
            return (
                <Root {...this.props.attributes}>
                    ...
                    <Content>
                        <Seatmap
                            addSeatCallback={this.handleAddSeat}
                            removeSeatCallback={this.handleRemoveSeat}
                            rows={rows}
                            maxReservableSeats={numbermaxReservableSeats}
                        />
                    </Content>
                    <Footer>
...
window.cognigyWebchatMessagePlugins.push(flightSeatPickerPlugin);
